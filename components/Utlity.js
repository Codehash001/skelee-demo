    ...
    {/* first row */}
      <div className="flex md:flex-row flex-col items-center justify-center my-1">
        ...
        <div className="w-[500px] flex flex-col items-center justify-center p-6">
          ...
          <p className='text-sm p-1 max-w-screen-sm'>Each NFT has unique value and desirability.
        ...
        <div className="w-[500px] flex flex-col items-center justify-center p-6">
          ...
          <p className='text-sm p-1 max-w-screen-sm'>Skelee's gaming champion league for
      ...
      {/* second-row */}
       <div className="flex md:flex-row flex-col items-center justify-center">
        ...
        <div className="w-[500px] flex flex-col items-center justify-center p-6">
          ...
          <p className='text-sm p-1 max-w-screen-sm'>Our immortal community is a lively
        ...
        <div className="w-[500px] flex flex-col items-center justify-center p-6">
          ...
          <p className='text-sm p-1 max-w-screen-sm'>Skelees argumented reality 'experience' will
