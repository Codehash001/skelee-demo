    ...
    {/* first row */}
      <div className="flex md:flex-row flex-col items-center justify-center my-1">
        ...
        <div className="w-[500px] flex flex-col items-center justify-center p-6">
          ...
          <h1 className='my-1 uppercase'>1 0F 1 ART PIECE</h1>
        ...
        <div className="w-[500px] flex flex-col items-center justify-center p-6">
          ...
          <h1 className='my-1 uppercase'>Gaming champions league</h1>
      ...
      {/* second-row */}
       <div className="flex md:flex-row flex-col items-center justify-center">
        ...
        <div className="w-[500px] flex flex-col items-center justify-center p-6">
          ...
          <h1 className='my-1 uppercase'>Immortal Community</h1>
        ...
        <div className="w-[500px] flex flex-col items-center justify-center p-6">
          ...
          <h1 className='my-1 uppercase'>Argumented Reality</h1>
