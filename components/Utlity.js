  ...
  return (
    ...
    {/* first row */}
      <div className="flex flex-row items-center justify-center border-b border-white">
        ...
        <div className="p-6 flex flex-col items-center justify-center border-r border-white">
          <img src="/1.jpg" className="w-[300px] h-[300px] rounded-lg"/>
        ...
        <div className="p-6 flex flex-col items-center justify-center border-l border-white">
          <img src="/1.jpg" className="w-[300px] h-[300px] rounded-lg"/>
