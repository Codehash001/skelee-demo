export default function Footer(){
    return(
        <div className=" bg-black w-full h-auto md:px-16 px-4">

<footer class="p-4 sm:p-6 text-white font-Kanit">
	<div className='flex items-center jutify-between w-full h-auto'>
		<div className='flex flex-col items-center jutify-between w-full h-auto'>
		  ...
		  <div className='flex items-center jutify-start w-full h-auto mt-6'>
		    ...
		    <h1 className='text-sm font-semibold'>&#169;2023 RARE STUDIOS NEW YORK. All Rights Reserved.</h1>
		  </div>
