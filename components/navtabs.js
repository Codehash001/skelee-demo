               ...
               <div className='w-[50%]'>
                ...
                <div className='w-[50%]'>
                  <div className='flex items-center justify-end'>
                    <div className={toggleState === 2 ? 'px-3 py-1 text-[13px] bg-green-500 text-white font-medium rounded-sm uppercase mr-2 cursor-pointer' : 'px-3 py-1 text-[13px] hover:border border-wh bg-green-500 text-white font-medium rounded-sm uppercase mr-2 cursor-pointer'}
                    onClick={() => toggleTab(2)}>
                      Mint
                    </div>
                    ...
                    <div className={toggleState === 2 ? 'px-3 py-1 text-[13px] bg-green-500 text-white font-medium rounded-sm uppercase mx-2 cursor-pointer' : 'px-3 py-1 text-[13px] hover:border border-wh bg-green-500 text-white font-medium rounded-sm uppercase mx-2 cursor-pointer'}
                    onClick={() => toggleTab(2)}>
                      Buy
                    </div>
                    <a href='/'>
                    <div className='px-5 py-1 text-[13px] bg-black hover:bg-gray-200 text-white font-medium rounded-sm uppercase mx-2 cursor-pointer'>
