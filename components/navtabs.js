               ...
               <div className='w-[50%]'>
                ...
                <div className='w-[50%]'>
                  <div className='flex items-center justify-end'>
                    ...
                    <div className={toggleState === 2 ? 'px-3 py-1 text-[13px] bg-[#3ae516] text-white font-medium rounded-sm uppercase mx-2 cursor-pointer' : 'px-3 py-1 text-[13px]  bg-[#3ae516] text-white font-medium rounded-sm uppercase mx-2 cursor-pointer'}
                    onClick={() => toggleTab(2)}>
                      Buy
                    </div>
                    <a href='/'>
          ...
          onClick={() => toggleTab(1)}/>
            ...
            <div className ={
              ...
              <div className='flex flex-col items-start text-start mt-4'>
                ...
                <div className='w-full uppercase py-2 border-b-2 border-black tracking-wider font-semibold text-[18px]'>Buy</div>
